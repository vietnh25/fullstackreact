...
class App extends Component {
  ...
  handleClick = () => {    
      var {product_name,product_price,anh} = this.state;   
      var dataTemp = [];      
      var item = {};
      ...
      addProductAction(product_name,product_price,anh).then((response)=>{
                ...
                <div className="row">
                  <form >
                    ...
                    <div className="form-group">
                      ...
                      <input onChange={(event)=> this.isChange(event)} type="text" className="form-control" name="anh" id="anh" aria-describedby="name_text" placeholder="Nhập ảnh sản phẩm" />
